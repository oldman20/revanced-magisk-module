...
https://github.com/luxysiv/revanced-nonroot

[About patching Reddit versions 2024.18.0+](https://github.com/inotia00/revanced-documentation/blob/main/docs/latest-reddit-patch-info.md)
...
[**Check which patches enable default**](https://api.revanced.app/v2/patches/latest) (**Open with https://jsoneditoronline.org/**) or https://github.com/ReVanced-Extended-Community/Patches-Documentation#patches-documentation

[**About icon inotia00 patches**](https://github.com/inotia00/revanced-patches/blob/revanced-extended/patches.json)
 ...
 * Customize [`config.toml`](./config.toml) using [rvmm-config-gen](https://j-hc.github.io/rvmm-config-gen/) Dùng cái generator rồi ấn nút Upload **patches.json** của [inotia](https://github.com/inotia00/revanced-patches/releases/latest) vào xong điền theo ý thôi. icon thì ghi `mmt`. (Hoặc tham khảo [**Revanced patches.json**](https://github.com/ReVanced/revanced-patches/releases/latest) hay [**inotia00 patches.json**](https://github.com/inotia00/revanced-patches/blob/revanced-extended/patches.json))
...
$ ./build.sh
```
# Additional/ # Một số tips, lưu ý:

<a href="https://visitcount.itsvg.in">
  <p align="center"><img src ="https://visitcount.itsvg.in/api?id=STEK1337&label=Visitors&color=12&icon=0&pretty=false" />
</a>

[**Thứ tự nguồn tải apk**](https://github.com/j-hc/revanced-magisk-module/blob/e7ae0800db0c748bc0723f0ce1e59a22c938873a/utils.sh#L381) Cái trước fail thì sẽ down bằng cái sau

[**sig.txt**](https://github.com/oldman20/revanced-magisk-module/blob/main/sig.txt) xác thực cert apk gốc

[việc fork repo đó bằng fork mỗi main branch và fork all (cả main lẫn update branch) là giống nhau: Build xong nó lại push lên branch update](https://github.com/j-hc/revanced-magisk-module/blob/e7ae0800db0c748bc0723f0ce1e59a22c938873a/.github/workflows/build.yml#L105)

# Nếu bị buffering (xoay vòng vòng) thì vào cài đặt Revanced bật Spoof client lên:
...
tắt spoof ios, lúc này thì nó có lỗi là tắt màn nếu video đang pause là nó resume với vài lỗi lặt vặt

Settings - revanced - video - default playback speed.
